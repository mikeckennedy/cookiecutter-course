...
class EmailService:
    ...
    __from_address = 'Talk Python <contact@talkpython.fm>'
    ...
    def send_welcome_email(cls, email):
        ...
        EmailService.send_email(email, 'Welcome to Show off web app', html_body)
    ...
    def send_password_reset_email(cls, email, reset_id):
        ...
        EmailService.send_email(email, 'Reset your password at Show off web app', html_body)
